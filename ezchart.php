<?php
	...
	if(isset($_SESSION['logged_in'])){
		 header("Location: ezchartlog.php");
	}
?>
...
<head>
	...
	<script type="text/javascript" src="ezcharscript.js"></script>
...
<body style="background-color:#e1e1e1;">
				...
				<center>
					<div class="carousel-inner" role="listbox" style="padding-right: 0px; padding-left: 0px;">
						<div class="item active">
							<img src="pict/banner3.png" alt="ezchart.php" style="width:1393.92px;height:400.48px;">
						</div>			
					</div>
				<center>
			</div>
	...
	<nav class="navbar container navbar-expand-sm navbar-inverse" style="margin-bottom:auto;">
			...
			<ul class="nav navbar-nav">
				...
				<li class="active"><a class ="text-white" href="ezchart.php?">EZChart</a></li>
	...
	<div class="container" style="background-color:grey;">
		<br>
		<div class="jumbotron" style="padding:auto; padding-right:0px;padding-left: 0px; padding-top:0.5px;">
			<center>
				<div class ="container">
					<div class="card-box">
				...
				<h3>
					<br>Bingung lagu favoritemu sudah ada ditempat karaoke atau belum?
					<br>
					Cek segera! hanya di EZChart
				</h3>
				<br>
				<br>
				<form>
					<div class="input-group container-sm" style="width: 560px;">
						<span class="input-group-addon">
						<i class="glyphicon glyphicon-search"></i></span>
		 				<input class="form-control" type="search" placeholder="Penyanyi, Lagu" id="search">
		 			</div>
      			</form>
			</center>
			...
			<div class="container">
				<div class="card-box">
      				<h3 class="hasil"> Hasil Pencarian Anda:</h3>
