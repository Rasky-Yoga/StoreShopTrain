		...
		<div class="row no-gutters mt-5">
			<div class="col-md-2 bg-dark mt-2 pr-3 pt-4">
				<ul class="nav flex-column ml-3 mb-5">
				  ...
				  <li class="nav-item">
					<a class="nav-link active text-white" href="#"><i class="fas fa-chart-line mr-2"></i>Record Pemesanan</a><hr class="bg-secondary">
				  </li>
				  <li class="nav-item">
			...
			<div class="col-md-10 p-5 pt-2">
				<h3 class="text-warning"><i class="fas fa-chart-line mr-2 text-warning"></i>RECORD PEMESANAN</h3><hr>
				...
				<div class="row text-white">
					<div class="card bg-info ml-5" style="width: 18rem;">
					  ...
					  <div class="card-body">
						...
						<div class="display-4">Ayo Ada lebih dari 100+ lagu favoritmu disini</div>
