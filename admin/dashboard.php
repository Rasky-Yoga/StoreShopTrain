		...
		<div class="row no-gutters mt-5">
			<div class="col-md-2 bg-dark mt-2 pr-3 pt-4">
				<ul class="nav flex-column ml-3 mb-5">
				  <li class="nav-item">
					<a class="nav-link active text-white" href="#"><i class="fas fa-user-circle mr-2"></i>Dashboard</a><hr class="bg-secondary">
				  </li>
				  <li class="nav-item">
			...
			<div class="col-md-10 p-5 pt-2">
				<h3 class="text-warning "><i class="fas fa-user-circle mr-2 text-warning"></i>DASHBOARD</h3><hr>
				
				<div class="row text-white">
				
					<div class="card bg-info ml-5" style="width: 18rem;">
					  <img src="logoK.jpg" class="card-img-top" alt="gambar">
					  <div class="card-body">
						<div class="card-body-icon">
							<i class="fas fa-chart-line mr-2"></i>
						</div>
						<h5 class="card-title">RECORD PEMESANAN</h5>
						<div class="display-4">Menampilkan Record Pemesanan</div>
					
						<a href="record_pemesanan.php" class="btn btn-primary">Go</a>
					  </div>
					</div>
					...
					<div class="card bg-danger ml-5" style="width: 18rem;">
					  ...
					  <div class="card-body">
						...
						<div class="display-4">Menambahkan Inputan Lagu Baru</div>
						
						<a href="input_lagu.php" class="btn btn-primary">Go</a>
					  </div>
					</div>
					
					<div class="card bg-warning ml-5" style="width: 18rem;">
					  <img src="logoN.jpg" class="card-img-top" alt="gambar">
					  <div class="card-body">
						<div class="card-body-icon">
							<i class="fas fa-database"></i>
						</div>
						<h5 class="card-title">RECORD USER</h5>
						<div class="display-4">Menampilkan Record User</div>
						
						<a href="record_user.php" class="btn btn-primary">Go</a>
					  </div>
					</div>
