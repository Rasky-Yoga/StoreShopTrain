...
session_start();
	...
	if(isset($_SESSION['logged_in'])){
 		header("Location: panduanlog.php");
	}
...
<body style="background-color:#e1e1e1;">
		...
		<div id="myCarousel" class="carousel slide" data-ride="carousel">
			...
			<div class="carousel-inner" role="listbox" style="padding-right: 0px; padding-left: 0px;">
				<div class="item active">
					<img src="pict/banner4.png" alt="panduan.php" style="width:1393.92px;height:400.48px;">
				</div>			
			</div>
			<center>
	...
	<nav class="navbar container navbar-expand-sm navbar-inverse" style="margin-bottom:auto;">
			...
			<ul class="nav navbar-nav">
				...
				<li class="active"><a class ="text-white" href="panduan.php">Panduan</a></li>
