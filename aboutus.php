<?php
	...
	if(isset($_SESSION['logged_in'])){
 		...
 		header("Location: aboutuslog.php");
	}
				...
				<div class="card" style="background-color: white;">
					<div class="card-body" style="margin:1px;">
						<div class= 'container mt-2 p-2'>
							...
							<div class="col-sm-6 col-md-4 card" style="background-color:#d9edf7; margin-left: 150px; margin-top: 20px; padding-top:15px;">
								<div class="thumbnail" stye>
									<img src="pict/adhi_use.jpg">
									<div class="caption text-center">
										<h3>Adhi Maheswara Putra</h3>
											<p style="text-align: center;">1805551130<br> Developer WEB CLIENT</p><br>
										<div class="text-center p-0 text-black-50">
											<span class="small text-capitalize">Temukan saya di:<br></span><br>
											<p>
												<a href="https://www.facebook.com/adhi.maheswara.putra"> <img src="pict/facebook-icon.png" style="width:25px ;height:25px;">adhimaheswara</i></a> <br>
											</p>
  										</div>
									</div>
								</div>
							</div> 
								<div class="col-sm-6 col-md-4 card" style="background-color:#d9edf7; margin-left: 55px; padding-top:15px; margin-top: 20px;">
								<div class="thumbnail" stye>
									<img src="pict/ras.png">
									<div class="caption text-center">
										<h3>Rasky Yoga A.</h3>
											<p style="text-align: center;">1805551134<br> Developer WEB SERVER</p><br>
										<div class="text-center p-0 text-black-50">
											<span class="small text-capitalize">Temukan saya di:<br></span><br>
											<p>
												<a href="https://www.facebook.com/raski.yoga"> <img src="pict/facebook-icon.png" style="width:25px ;height:25px;">RaskyYoga</i></a> <br>
											</p>
  										</div>
									</div>
								</div>
